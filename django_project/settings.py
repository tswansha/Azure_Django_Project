...
SECRET_KEY = "django-insecure-l_&vorg3n+_p8&b6an^n2@fxh8zc!!eoxz0-r0716=8-@)1ph@"
...
INSTALLED_APPS = [
    ...
    # local
    "pages.apps.PagesConfig",  # Added line for introduces pages apps config class
    "accounts.apps.AccountsConfig",  # Added line for introduce accounts app config class
    # 3rd Party
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / "templates"],  # Added template folder
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
